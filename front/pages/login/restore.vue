    ...
    <v-card class="pa-8">
      ...
      <v-row class="pb-3">
        <v-col cols="12" class="text-center">
          <p>Введите адрес электронной почты. На указанный адрес будет отправлено письмо со ссылкой для восстановления пароля</p>
        </v-col>
      </v-row>
      ...
      <v-row>
        ...
        >
          <p>Вы можете отправить повторный запрос через {{ countDown }} сек</p>
        </v-col>
      </v-row>
